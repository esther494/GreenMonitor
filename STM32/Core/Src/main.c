...
osThreadId FromESPHandle;
osThreadId DispScreenHandle;
/* USER CODE BEGIN PV */
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
float temperature_humidity_buffer [2] = {0};
uint32_t light_moisture_dma[2] = {0};
...
int parsedErrorCode;
char parsedTime[150];
char parsedTemperature[150];
char parsedHumidity[150];
char parsedUVIndex[150];
char parsedMoisture[150];
char parsedGeneral[150];
...
/* USER CODE BEGIN Header_StartFromESP */
/**
 * @brief Function implementing the FromESP thread.
 * @param argument: Not used
 * @retval None
 */
...
/**
* @brief Function implementing the DispScreen thread.
* @param argument: Not used
* @retval None
*/
